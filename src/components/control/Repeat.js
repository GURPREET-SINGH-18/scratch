...
const Repeat = ({ comp_id, events, set_repeat }) => {
    ...
    return (
        // Repeat Component
        <Paper elevation={3}>
            <div className="rounded text-center bg-purple-400 p-2 my-3">
                <div className="grid grid-cols-2 my-2">
                    <div className="text-black">Repeat</div>
                    <input
                ...
                <div
                    id={comp_id}
                    className="text-center bg-purple-700 text-white rounded px-2 py-1 my-2 text-sm cursor-pointer"
                >
                    Repeat By {repeat}
                </div>
            </div>
