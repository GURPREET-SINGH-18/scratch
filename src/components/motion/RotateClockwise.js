    ...
    <Paper elevation={3}>
      <div className="text-center rounded bg-yellow-300 p-2 my-3">
        <div className="grid grid-cols-2">
          <div className="text-black">Rotate By:</div>
          <input
        ...
        <div
          id={comp_id}
          className={`flex bg-black text-yellow-400 rounded px-2 py-1 mt-3 mb-1 text-sm cursor-pointer text-center`}
          onClick={() => handleClick()}
        >
          <div className="flex mx-auto">
            Click here to
            <RedoIcon className="mx-2" /> {angle}°
          </div>
        </div>
      </div>
    </Paper>
